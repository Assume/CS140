...
public class InstructionTester {
	...
	public void testNOP() {
		...
		assertEquals("Program counter incremented", ipInit + 1, machine.getPC());
		// Test accumulator untouched
		assertEquals("Accumulator unchanged", accInit, machine.getAccum());
	}
	...
	public void testLODI() {
		...
		assertEquals("Accumulator changed", 12, machine.getAccum());
	}
	...
	public void testLOD() {
		...
		assertEquals("Program counter incremented", ipInit + 1, machine.getPC());
		// Test accumulator modified
		assertEquals("Accumulator changed", -2560 + 120, machine.getAccum());
	}
	...
	public void testLODN() {
		...
		assertEquals("Program counter incremented", ipInit + 1, machine.getPC());
		// Test accumulator modified
		assertEquals("Accumulator changed", -2560 + 400, machine.getAccum());
	}
	...
	public void testSTO() {
		...
		assertEquals("Accumulator unchanged", 567, machine.getAccum());
	}
	...
	public void testJMP0() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was changed", 170, machine.getPC());
		assertEquals("Accumulator was not changed", 100, machine.getAccum());
	}
	...
	public void testJMP2() {
		...
		// should have set the program counter to 40
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was changed", 260, machine.getPC());
		assertEquals("Accumulator was not changed", 200, machine.getAccum());
	}
	...
	public void testJMP4() {
		...
		// should have set the program counter to 40
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was changed", 60, machine.getPC());
		assertEquals("Accumulator was not changed", 200, machine.getAccum());
	}
	...
	public void testJMP6() {
		...
		// should have set the program counter to 40
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was changed", 40, machine.getPC());
		assertEquals("Accumulator was not changed", 200, machine.getAccum());
	}
	...
	public void testJMPZ0() {
		...
		// should have set the program counter to 40
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was changed", 270, machine.getPC());
		assertEquals("Accumulator was not changed", 0, machine.getAccum());
	}
	...
	public void testJMZ0accumNonZero() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was incremented", ipInit + 1, machine.getPC());
		assertEquals("Accumulator was not changed", 200, machine.getAccum());
	}
	...
	public void testADDI() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was incremented", ipInit + 1, machine.getPC());
		assertEquals("Accumulator was changed", 200 + 12, machine.getAccum());
	}
	...
	public void testADD() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was incremented", ipInit + 1, machine.getPC());
		assertEquals("Accumulator was changed", 200 - 2560 + 120, machine.getAccum());
	}
	...
	public void testADDN() {
		...
		assertArrayEquals(dataCopy, machine.getData());
		assertEquals("Program counter was incremented", ipInit + 1, machine.getPC());
		assertEquals("Accumulator was changed", 200 - 2560 + 400, machine.getAccum());
	}
	...
	public void testANDIaccEQ0argEQ0() {
		...
		assertEquals("Program counter incremented", ipInit + 1, machine.getPC());
		// Accumulator is 1
		assertEquals("Accumulator is 0", 0, machine.getAccum());
	}
	...
	public void testANDIaccGT0argGT0() {
		...
		assertEquals("Program counter incremented", ipInit + 1, machine.getPC());
		// Accumulator is 1
		assertEquals("Accumulator is 1", 1, machine.getAccum());
	}
	...
	public void testFORImmediate() {
		...
		machine.setCode(0, 0);
		machine.setCode(0, 0);
		machine.setCode(17, 1);
		machine.setCode(43, 1);
		machine.setCode(20, 1);
